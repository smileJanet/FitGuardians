                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="chatModalLabel1">Chat with Emily</h5>
                                        ...
                                        <div id="chatMessages" style="height: 300px; overflow-y: auto; border: 1px solid #ddd; padding: 10px;">
                                            ...
                                            <div class="d-flex mb-3">
                                                ...
                                                <div class="bg-light p-2 rounded" style="max-width: 70%;">
                                                    ...
                                                    <small class="text-muted">Emily · 58m</small>
                                                </div>
                                            </div>
                                            <div class="d-flex justify-content-end mb-3">
                                                <div class="bg-primary text-white p-2 rounded" style="max-width: 70%;">
                                                    <p class="mb-0">Sure! What do you need help with?</p>
                                                    <small class="text-muted">You · 57m</small>
                                                </div>
                                            </div>
                                            <div class="d-flex mb-3">
                                                <div class="mr-2">
                                                ...
                                                <div class="bg-light p-2 rounded" style="max-width: 70%;">
                                                    ...
                                                    <small class="text-muted">Emily · 56m</small>
                                                </div>
                                            </div>
                                            <!-- 더 많은 메시지를 추가하여 채팅을 길게 보이게 할 수 있습니다. -->
                                        </div>
                                        <!-- 입력 영역 -->
