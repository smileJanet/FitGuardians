...
<!-- Custom fonts for this template-->
    ...
    <link href="resources/templates/css/sb-admin-2.min.css" rel="stylesheet">
    ...
    <script defer src="resources/templates/js/sb-admin-2.min.js"></script>

    <!-- Page level plugins -->
    <script defer src="resources/templates/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script defer src="resources/templates/js/demo/chart-area-demo.js"></script>
    <script defer src="resources/templates/js/demo/chart-pie-demo.js"></script>
...
<body id="page-top">
    ...
    <jsp:include page="../common/traineeSidebar.jsp" />
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">뫅두팔님, 환영해요!</h1>
                    </div>
